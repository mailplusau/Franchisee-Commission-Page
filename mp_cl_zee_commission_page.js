...
function operatorTable(operator_dict) {
    ...
    inlineQty += '<th scope="col" id="table_operator_commission">Service Revenue / Commission (excl. GST)</th>'
    inlineQty += '<th scope="col" id="table_operator_commission_tax">Tax</th>'
    inlineQty += '<th scope="col" id="table_operator_commission_total">Service Revenue / Commission (incl. GST)</th>'
    inlineQty += '</tr>'
    inlineQty += '</thead>'
